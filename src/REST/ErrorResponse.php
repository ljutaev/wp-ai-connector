...
final class ErrorResponse {
	 ...
	 */
	public static function make( string $code, string $message, int $status, array $data = array() ): WP_Error {
	...
	public static function forbidden_capability( string $cap ): WP_Error {
		return self::make( 'wpaic_forbidden_cap', "Required capability '{$cap}' is missing.", 403, array( 'capability' => $cap ) );
	}

	public static function forbidden_scope( string $scope ): WP_Error {
		return self::make( 'wpaic_forbidden_scope', "Required scope '{$scope}' is missing from this key.", 403, array( 'scope' => $scope ) );
	}
	...
	public static function validation( string $message, string $field ): WP_Error {
		return self::make( 'wpaic_validation', $message, 400, array( 'field' => $field ) );
	}
}

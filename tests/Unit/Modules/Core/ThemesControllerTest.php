...
final class ThemesControllerTest extends TestCase {
	...
	public function test_permissions_check_requires_switch_themes(): void {
		...
		self::assertSame( 'switch_themes', $data['capability'] );
	}

	public function test_permissions_check_returns_true_when_capable(): void {
		Functions\when( 'current_user_can' )->justReturn( true );

		$result = ( new ThemesController() )->permissions_check(
	...
	public function test_register_routes_calls_register_rest_route(): void {
		...
		( new ThemesController() )->register_routes();

...
final class MediaControllerTest extends TestCase {
	...
	public function test_permissions_check_requires_upload_files(): void {
		...
		self::assertSame( 'upload_files', $data['capability'] );
	}

	public function test_permissions_check_returns_true_when_capable(): void {
		Functions\when( 'current_user_can' )->justReturn( true );

		$result = ( new MediaController() )->permissions_check(
	...
	public function test_register_routes_calls_register_rest_route(): void {
		...
		( new MediaController() )->register_routes();
